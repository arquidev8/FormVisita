...
app.get('/parte_de_visita.pdf', function(req, res){
...
app.post('/generar-pdf', (req, res) => {
  try {
    ...
    doc.fontSize(11).font('Helvetica')
      ...
      .text(`DIRECCIÓN / Address: ${direccion}`, 100, 120)
      .text(`CIUDAD / City: ${poblacion}`, 100, 140)
      ...
      .text(`NIF (DNI/NIE/Passport): ${pasaporte}`, 100, 240)
      ...
      .text(`OBSERVACIONES / COMMENTS:`, 100, 515, {align: 'center'})
